...
export const P = {
  ...
  cakeLatte: { src: '/photos/noa/cake-latte.jpg', w: 1800, h: 2400,
    alt: 'Un cappuccino et une part de gâteau du jour, près de la fenêtre, chez NOA' },
  ...
  noemie: { src: '/photos/noa/noemie.jpg', w: 1000, h: 1500,
    alt: 'Noémie devant la vitrine de NOA, rue Mélingue' },
  lounge: { src: '/photos/noa/lounge.jpg', w: 1600, h: 2400,
    alt: 'Le salon du local voisin : canapé, table basse, livres et un latte' },

  /* Le nouveau local, fourni par NOA. Aucune de ces vues ne montre
     d'assiette ni de tasse : la rubrique Le lieu n'en montre plus. */
  salonVue: { src: '/photos/noa/salon-vue.jpg', w: 1400, h: 2307,
    alt: 'La nouvelle salle de NOA : canapé, tables rondes et lanterne en papier' },
  salonLarge: { src: '/photos/noa/salon-large.jpg', w: 1400, h: 2307,
    alt: 'Le salon du nouveau local, banquette et tables basses' },
  salonLanterne: { src: '/photos/noa/salon-lanterne.jpg', w: 1400, h: 2307,
    alt: 'Le canapé du nouveau local sous la lanterne en papier' },
  salonCadre: { src: '/photos/noa/salon-cadre.jpg', w: 1400, h: 2307,
    alt: 'La banquette et le cadre au mur, dans le nouveau local' },
  ...
  /* Cadrages larges fournis par NOA. Utilisés partout où l'image
     ...
     Livrés en 1672 px, ils étaient agrandis 1,5 fois par le
     navigateur en plein cadre — d'où le flou. Ils sont ré-échelonnés
     à 2400 px en Lanczos avec un masque flou léger : ça n'ajoute
     aucun détail, mais l'agrandissement est fait proprement une fois
     pour toutes au lieu d'être bâclé à chaque affichage. Un original
     4K resterait meilleur. */
  heroWide: { src: '/photos/noa/hero-wide.jpg', w: 2400, h: 1351,
    alt: 'La devanture de NOA le soir, son store vert et sa salle éclairée' },
  spreadWide: { src: '/photos/noa/spread-wide.jpg', w: 2400, h: 1351,
    alt: 'Une table de NOA vue de dessus : tartines, matcha, cafés et pain de seigle' },
  ...
  latteWide: { src: '/photos/noa/latte-wide.jpg', w: 2400, h: 1351,
  ...
  carrotCakeWide: { src: '/photos/noa/carrot-cake-wide.jpg', w: 2400, h: 1351,
...
/* Aucun recoupement avec FAVORIS, qui est juste au-dessus sur la même
   page : le brownie, le cookie et le carrot cake y sont déjà. */
export const SOCIAL = [P.spread, P.toast, P.latte, P.card, P.coffee, P.matcha];
